...
function App() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <a target='_blank' className="text-primary text-sm bottom-1 fixed left-1/2 -translate-1/2" href="https://www.helloworldyazilim.com/">Hello World Yazılım Akademi</a>
    </div>
  );
}
